	...
	<div class="row">
		<div class="col-sm-4 col-md-3 d-none d-sm-block bg-light sidebar ">
			<ul class="nav nav-pills flex-column">
				<li class="nav-item">
					<a class="nav-link" data-toggle="collapse" href="#collapseBoard" aria-expanded="false" aria-controls="collapseBoard">
						게시판 관리
					</a>
				...
				<li class="nav-item">
					<a class="nav-link active" href="${contextpath}/Admin/pp.jsp">고객센터 관리</a>
				</li>
